...
### 2.4.2 MonogoDB 특징
MongoDB의 특징은 정말 많지만 크게 17가지입니다. 
...
9. TDE를 통해 보안 적용가능(범위검색에 경우 좋음) 응용프로그램으로 보안이 가능(`bcrypt`)하지만 범위검색의 경우 수행이 불가한 것을 해결해줍니다.
10. 3.2이상 wired Tiger엔진이 default로 사용됩니다.

...
## 8.5 - 8.11 고통이 있을 때 좀 참으면서 계획마무리에 집중하자
 - [x] 출판 원고 - 4장 소스코드수정 
...
## 8.12 - 8.18     
 ...
 - [ ] 쿠버네티스 공부
 - [ ] Lucid CodForce 업데이트 :: 모바일 / 배포 / 폰트 / localStorage
 - [ ] React - 인프런
...
## 9.3 ~ 9.9
 - [ ] React로 만드는 Level Up! 할일 앱 

## 9.9 ~ 9.16
 - [ ] React- Native로 만드는 Level Up! 할일 앱 
 - [ ] 라인플러스 서류접수

## 9.17 ~ 9.23
 - [ ] React- Native로 만드는 5장, 아트보리
...
4. 공주대에 가서 주완이형에게 축의금 + 강연을 하고 온다. 
5. 코드포스 Orange가 된다. 
6. 아트보리를 배포한다. 
...
## 8.26 - 9.1 50% 고통이 심해서 스트레스가 심함
 - [x] 카카오 기출 - 11문제
 - [x] 알고리즘 트레이닝 - 165쪽까지
 - [x] 루시드 어드벤처 : 디자인 작업
  - https://brunch.co.kr/@seonyu10/26

## 9.2 ~ 9.8
 - [ ] 카카오 기출 나머지 및 복습 
 - [ ] 출판 원고
  - 1. Vue.js로 progressbar 플러그인 제작[x]
  - 2. aggregate와 mapReduce의 성능비교 예제 단계적으로 및 따라하면서 할 수 있게 수정
  - 3. D3.js의 기초 제작[x]
  - 4. 실시간 서버 구축과 차트 컴포넌트 - 코드 툴팁 추가[x]

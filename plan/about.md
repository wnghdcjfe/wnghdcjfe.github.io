...
요약본
대학교 재학시절 강의평가 공유공간이 없다는 문제점을 파악하고 공주대학교 강의평가페이지를 만들고 공주대학교 커뮤니티를 만들고 학사장교로 공군에 들어가 군생활동안 기상 데이터기반의 프로그램들을 유지보수 및 개발하는 일을 대한민국 전 비행단에 설치되는 기상정보지원체계를 개발했으며 취미로 피아노를 치고 모여서 알고리즘 푸는 모임(모알푸)을 운영하고 있습니다. 



대학교 재학시절 강의평가 공유공간이 없다는 문제점을 파악하고 공주대학교 강의평가페이지를 만들고 공주대학교 커뮤니티를 만들고 학사장교로 공군에 들어가 군생활동안 기상 데이터(바람, 습도, 온도) 기반의 프로그램들을 유지보수 및 개발하는 일을 담당했으며 꾸준한 코드 리팩토링, 자체강의(91회)를 진행했습니다.  특히 대한민국 전 비행단에 설치되는 기상정보지원체계 프로젝트의 팀장을 맡아  2년 동안 서버구축부터 엔드포인트까지 개발하였습니다.  항상 조금 더 좋은 UI / UX를 구축하고자 Pinterest 등 좋은 사이트를 찾아다니고 성능향상을 위해 코드 하나하나 꼼꼼히 짜는 습관을 가지고 있습니다. 어떤 함수를 쓸 지, 어떤 로직을 쓸지 항상 고민하며 좀 더 좋은 코드를 위해 꾸준히 알고리즘을 공부하고 있습니다. 그리고 이러한 노력은 실제 현업에서의 피벗알고리즘, 메모이제이션알고리즘 적용을 통한  성능향상 및 트러블슈팅해결로 이어지기도 했습니다. 
 
기술공유와 책을 읽고 리뷰하는 것을 좋아해 블로그를 운영하고 있으며 새로운 기술로 미니프로젝트를 진행하는 것을 즐겨 IOT/딥러닝 미니 프로젝트를 진행하기도 했으며 만들고 싶은 것을 만들며 오픈소스 제작을 하고 있으며 모여서 알고리즘 푸는 모임(모알푸)을 운영하고 있습니다. 
...
만들고 이어 공주대학교 커뮤니티를
만들었습니다.
그 후 공군장교로 입대후 3 년동안 기
상데이터기반의 프로그램들을 개발했
으며 특히 대한민국 전 비행단에 설치
되는 기상정보지원체계 프로젝트의
팀장을 맡아 6 명의 팀원을 이끌며 2 년
동안 백엔드부터 프론트엔드까지 전부
개발하였습니다.
항상 조금 더 좋은 UI / UX 를 구축하고
자 Pinterest 등 좋은 사이트를 찾아다
니고 코드 하나하나 꼼꼼히 짜는 습관
을 가지고 있으며 더 나은로직을 위해
18 년부터 꾸준히 알고리즘 공부를 하
고 있습니다.
IT, 철학, 분야에 관계없이 책을 읽는
것을 좋아해 독후감블로그인 네이버
블로그(jhc9639.blog.me)를 운영하고
있으며 기술블로그인 큰돌의 터전(kun
dol.kr)를 운영하고 있으며 모여서 알고
리즘 푸는 모임(모알푸)을 운영하고
있습니다.